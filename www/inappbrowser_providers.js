/*!
 * ngCordova Overwrites && providers
 *
 * Copyright 2016 Modyo http://modyo.com/
 * See LICENSE in this repository for license information
 */
(function(){

  //overwrites the inAppBrowser
  var ngCordovaInAppBrowser = angular.module('ngCordova.plugins.inAppBrowser');

  ngCordovaInAppBrowser.provider('$cordovaInAppBrowser', [function () {
